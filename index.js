...
const botkahrba= ['465701100352176128']; // الايدي بتاعك انتا ووالادارة
...
bot.on('ready', () => {
	// -
  bot.user.setActivity("The End",{type: 'WATCHING'});
  console.log('            ╔[════════════]╗');
...
bot.login(botSettings.NDg4ODcxNzc5NDI3ODExMzI5.Dnj4bw.wT8sQb0a5P1rTDiHi1O6YrGXgZg);
